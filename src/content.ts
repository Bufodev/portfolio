...
const ukrainian: SiteContent = {
  ...
  about:
    "Я Буфо — веброзробник, який перетворює нечіткі ідеї на вивірені, продуктивні цифрові продукти. Моя спеціалізація — чисті інтерфейси та лендінги, орієнтовані на конверсію й реальні заявки, а не лише на гарну картинку.",
  country: "Україна",
  skillHeaders: [
    "ОСНОВНІ НАВИЧКИ",
    "ФРОНТЕНД",
...
const russian: SiteContent = {
  ...
  about:
    "Я Буфо — веб-разработчик, который превращает неясные идеи в продуманные, производительные цифровые продукты. Моя специализация — чистые интерфейсы и лендинги, ориентированные на конверсию и реальные заявки, а не только на красивую картинку.",
  country: "Украина",
  skillHeaders: [
    "КЛЮЧЕВЫЕ НАВЫКИ",
    "ФРОНТЕНД",
